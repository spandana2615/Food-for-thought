				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="banner-info">
							...
							<p>Food waste refers to the decrease in the quantity or quality of food resulting from decisions and actions by retailers, food service providers and consumers</p>
